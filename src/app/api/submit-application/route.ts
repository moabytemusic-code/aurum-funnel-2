...
export async function POST(request: NextRequest) {
  try {
    ...
    const senderEmail = process.env.BREVO_SENDER_EMAIL || 'noreply@aurumai.com'
    const senderName = process.env.BREVO_SENDER_NAME || 'AURUM AI'
    ...
    if (brevoApiKey && brevoApiKey !== 'your-brevo-api-key-here') {
      ...
      const sendEmailRes = await fetch('https://api.brevo.com/v3/smtp/email', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Welcome to AURUM AI — Your Application is Received',
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#0f172a,#1e293b);padding:40px;text-align:center;">
              <h1 style="color:#ffffff;margin:0;font-size:28px;font-weight:700;">AURUM<span style="color:#3b82f6;">AI</span></h1>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="color:#475569;font-size:16px;line-height:1.6;margin:0 0 20px;">
                Thank you for your interest in AURUM AI. We've received your application and our team is reviewing it now.
              </p>
          ...
          <tr>
            <td style="background-color:#f8fafc;padding:30px;text-align:center;border-top:1px solid #e2e8f0;">
              <p style="color:#94a3b8;font-size:13px;line-height:1.6;margin:0;">
                This email was sent to you because you submitted an application through the AURUM AI onboarding portal.<br>
                © ${new Date().getFullYear()} AURUM AI. All rights reserved.
              </p>
